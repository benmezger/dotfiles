...
# zsh prompt
AGKOZAK_CUSTOM_PROMPT+="@ %1~ "
AGKOZAK_CUSTOM_PROMPT+='%F{${AGKOZAK_COLORS_VIRTUALENV:-green}}${AGKOZAK_VIRTUALENV_CHARS[1]-[}%10v${AGKOZAK_VIRTUALENV_CHARS[2]-]}%f '
AGKOZAK_CUSTOM_PROMPT+="%(4V.:.$) "
AGKOZAK_COLORS_VIRTUALENV=8
