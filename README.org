...
This is because =chezmoi= requires =1password= to be logged in for filling any
secrets. Make sure your 1password UUIDS are up to date, see [[https://github.com/twpayne/chezmoi/blob/master/docs/HOWTO.md#use-1password-to-keep-your-secrets][this]] for more
information. After setting all your UUIDS, login with =eval $(op signin)= and
finally, =chezmoi apply=
